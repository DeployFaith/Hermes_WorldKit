...
@onready var eye_textures = {
	"a": preload("res://addons/hermes_os/addons/godot_wry/examples/character_creator_ui_demo/assets/character/tex_eyes_1.png"),
	"b": preload("res://addons/hermes_os/addons/godot_wry/examples/character_creator_ui_demo/assets/character/tex_eyes_2.png"),
}
